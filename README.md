# Proyecto Final de Python - Máster en Inteligencia Artificial

Bloque de ejercicios prácticos en Python enfocados en lógica algorítmica, estructuras de datos y fundamentos de desarrollo para Inteligencia Artificial.
...
# 3. Entrar en la carpeta específica del proyecto
cd ProyectoFinalPython-Adina

# 4. Ejecutar el script que desees (por ejemplo, el Ejercicio 1)
python ej1.py
